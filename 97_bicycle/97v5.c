        ...
        */
        ...
        for (int k = 0; k < num_parkinglot; k++)
        {
            ...
            for (int j = 0; j < num_parkinglot; j++)
            {
                ...
                int exist[num_parkinglot];
                for (int l = 0; l < num_parkinglot; l++)
                {
                    exist[num_parkinglot] = 0;
                }
                ...
                for (int l = 0; l < num_parkinglot; l++)
                {
                    ...
                    if ((exist[l] == 1 && parkx[l] < parkx[index] || (parkx[l] == parkx[index] && parky[l] < parky[index])) && count_of_park[l] < capacity[l] )
                    {
                        count_of_park[l]++;
                        tempj = 1;
                        tempk = 1;
